...
- **Breake expectations** by first creating them and then revealing data that runs counter or surpasses the expected.
...
A major barrier in data presentation is information overload. Stick to these guidelines to maintain focus:
...
Don't let the presentation just "fade out." Finish with a resolution that changes behavior. Do one or more of the following:
